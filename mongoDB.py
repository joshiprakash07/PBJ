# Mongo DB lacture
import pymongo
client = pymongo.MongoClient("mongodb+srv://joshiprakash07:Pages123@cluster0.fww8a.mongodb.net/?retryWrites=true&w=majority")
db = client.test
dict1 = {'name':'Prakash',
         'age': 32,
         'Profession':'Data Scientist',
         'Email':'joshiprakash07@gmail.com'}
# database = client['MyInfo']
# collection = database['Prakash']
